...
- **All UI art is original** — the character portraits and scene backdrops in the web client are hand-authored inline SVG (no third-party assets, no real-person likenesses). Optional drop-in PNGs, if added, should likewise be original or generated as fictional characters.
